...
import { documentParseRouter } from './routes/documentParse';
import { generateRouter } from './routes/generate';
import { parseRouter } from './routes/parse';
import { parsingStatusRouter } from './routes/parsingStatus';
import jobSourcesRouter from './routes/jobSources';
...
// Initialize the WebSocket server via our extracted module.
